error id: file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/llm/LLMClient.java:com/wuxiansheng/shieldarch/marsdata/utils/DiSFUtils#
file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/llm/LLMClient.java
empty definition using pc, found symbol in pc: com/wuxiansheng/shieldarch/marsdata/utils/DiSFUtils#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 382
uri: file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/llm/LLMClient.java
text:
```scala
...
import com.wuxiansheng.shieldarch.marsdata.utils.DiSFUtil@@s;
import lombok.Data;
