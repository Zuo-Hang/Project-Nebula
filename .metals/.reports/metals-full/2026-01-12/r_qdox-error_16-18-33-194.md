error id: file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/business/xlbubble/poster/XLFilterSupplier.java
file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/business/xlbubble/poster/XLFilterSupplier.java
...
```java
offset: 2494
uri: file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/business/xlbubble/poster/XLFilterSupplier.java
text:
```scala
    ...
    public Business apply(BusinessContext bctx, Business business) {
        ...
        for (ReasonSupplierResult supplierInfo : gb.getReasonResult().getSuppliersInfo()) {
            if (appConfigService instanceof ApolloConfigService) {
                ...
                if (apolloConfigService.isValidSupplier(supplierInfo.getSupplier(), businessName)) {
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/business/xlbubble/poster/XLFilterSupplier.java