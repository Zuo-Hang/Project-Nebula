error id: file://<WORKSPACE>/new-project/step-executors/src/main/java/com/wuxiansheng/shieldarch/stepexecutors/executors/InferenceExecutor.java:_empty_/LangChain4jLLMServiceClient#
file://<WORKSPACE>/new-project/step-executors/src/main/java/com/wuxiansheng/shieldarch/stepexecutors/executors/InferenceExecutor.java
empty definition using pc, found symbol in pc: _empty_/LangChain4jLLMServiceClient#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1076
uri: file://<WORKSPACE>/new-project/step-executors/src/main/java/com/wuxiansheng/shieldarch/stepexecutors/executors/InferenceExecutor.java
text:
```scala
...
public class InferenceExecutor implements StepExecutor {
    ...
    @Autowired(required = false)
    private LangChain4jLLMServiceClie@@nt langChain4jLLMServiceClient;
